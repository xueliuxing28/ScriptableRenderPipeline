...
namespace UnityEditor.Rendering.Universal
{
    ...
    [MovedFrom("UnityEditor.Rendering.LWRP")] public class UniversalRenderPipelineAssetEditor : Editor
    {
        internal class Styles
        {
            ...
            public static string postProcessingGlobalWarning = "The Post-processing Feature Set in the render pipeline asset is set to Post-processing V2. This volume component will not have any effect.";
