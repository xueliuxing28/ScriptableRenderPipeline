    ...
    public partial class HDRenderPipeline
    {
        ...
        internal class LightLoopTextureCaches
        {
            ...
            public void Initialize(HDRenderPipelineAsset hdrpAsset, RenderPipelineResources defaultResources,  IBLFilterBSDF[] iBLFilterBSDFArray)
            {
                ...
                cookieTexArray.AllocTextureArray(coockieSize, coockieResolution, coockieResolution, GraphicsFormat.R8G8B8A8_UNorm, true);
                ...
                cubeCookieTexArray.AllocTextureArray(coockieCubeSize, coockieCubeResolution, GraphicsFormat.R8G8B8A8_UNorm, true, m_CubeToPanoMaterial);
